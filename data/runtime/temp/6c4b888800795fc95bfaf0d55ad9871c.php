<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/back\setmeal\add.html";i:1535173333;s:88:"E:\phpStudy\PHPTutorial\WWW\tenstudio\public\themes\admin_simpleboot3\public\header.html";i:1529968519;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
	...
	<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo request()->action(); ?>">
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-10">
				<input type="text" class="form-control" name="sort" placeholder="数值越大越靠前,默认0">
			</div>
		</div>
		<div class="form-group">
